...
- **チャンク (chunk)★** … ゲーム内で一度に表示される **部屋サイズの迷路ブロック** のこと。基本は **12×12 タイル**。
...
| チャンク | タイルを 12×12 個並べた大部屋 | ゲームが描画する単位  |
