...
|10 | **出口通過** | — | — | `camera.flash`120 ms + `shake`3 px | チャンク数ポップ表示 |
|11 | **チャンク生成** | — | — | Container `alpha`0→1 / `y`+24→0 (0.4 s) | 暗闇から島浮上 |
|12 | **旧チャンク蒸発** | — | — | 黒マスク拡張＋黒粒子蒸発 | 主人公が2チャンク以上離れたとき |
|13 | **旧チャンク崩落** | — | — | 黒ブロック粒子が落下 | モバイル負荷時はOFF |
|14 | **次チャンク突入** | — | — | `camera.pan`400 ms + `zoom`2→1.9→2 | 島ジャンプ感 |
|15 | **ゲームオーバー** | — | — | 画面 `fade`#000 800 ms / LPF→200 Hz | 粒子が暗闇へ吸い込まれる |
